	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'options',
				options: [
					{ name: 'חשבונית מס', value: 'taxinvoice' },
					{ name: 'חשבונית מס קבלה', value: 'invoicereceipt' },
					{ name: 'קבלה', value: 'receipt' },
					{ name: 'הצעת מחיר', value: 'priceQuote' },
					{ name: 'תעודת משלוח', value: 'deliveryNote' },
					{ name: 'חשבונית זיכוי', value: 'refund' },
				],
				default: '',
