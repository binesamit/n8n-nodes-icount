...
export async function executeUpdateCustomer(this: any, index: number): Promise<any> {
	...
	if (employeeAssigned) body.employee_assigned = employeeAssigned;
	if (clientTypeId) body.client_type_id = clientTypeId;
